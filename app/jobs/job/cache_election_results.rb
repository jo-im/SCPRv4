module Job
  class CacheElectionResults < Base
    ...
    RACES = {
      ...
      "Board of Equalization District 1 - Districtwide Results"          => "state.equalization_d1",
      "Board of Equalization District 2 - Districtwide Results"          => "state.equalization_d2",
      "Board of Equalization District 3 - Districtwide Results"          => "state.equalization_d3",
      ...
      "State Assembly District 35 - Districtwide Results" => "state.assembly-d35",
      ...
      "State Assembly District 65 - Districtwide Results" => "state.assembly-d65",
      ...
      "State Assembly District 68 - Districtwide Results" => "state.assembly-d68",
      "State Assembly District 69 - Districtwide Results" => "state.assembly-d69",
      ...
      "State Assembly District 72 - Districtwide Results" => "state.assembly-d72",
      "State Assembly District 73 - Districtwide Results" => "state.assembly-d73",
