...
describe RecurringScheduleRule do
  let(:valid_record) { build :recurring_schedule_rule, start_time: "11:00" }
  let(:invalid_record) { build :recurring_schedule_rule, start_time: "" }
  let(:updated_record) { build :recurring_schedule_rule, start_time: "12:00" }
  ...
  describe "Versions" do
    ...
    context "new record" do
      it "saves an initial version" do
        ...
        select valid_record.program.title, from: "recurring_schedule_rule_program_obj_key"
        click_button "edit"
    ...
    context "existing record" do
      it "saves a new version" do
        ...
        select updated_record.program.title, from: "recurring_schedule_rule_program_obj_key"
        click_button "edit"
      ...
      context "invalid" do
        it "shows validation errors" do
          if invalid_record
            ...
            select invalid_record.program.title, from: "recurring_schedule_rule_program_obj_key"
            click_button "edit"
