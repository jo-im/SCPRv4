...
describe Api::Public::V3::EpisodesController do
  request_params = {
    :format => :json
  }
  ...
  describe "GET index" do
    ...
    it 'can filter by air date' do
      episode1 = create :show_episode, air_date: Time.zone.local(2013, 6, 25)
      episode2 = create :show_episode, air_date: Time.zone.local(2013, 6, 24)
  ...
  describe "GET archive" do
    it "finds the object if it exists" do
      ...
      get :archive, { program: "test-program", year: '2015', month: '2' }.merge(request_params)
