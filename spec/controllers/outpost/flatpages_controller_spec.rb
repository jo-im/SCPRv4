    ...
    context "existing object" do
      it "builds the object from existing attributes and assigns new ones" do
        ...
        put :preview,
          ...
          :flatpage   => flatpage.attributes.merge(title: "Updated")
      ...
      it "notifies that there will be a redirect if it is a redirect" do
        flatpage = create :flatpage,
          :redirect_to => "http://google.com/sweet_redirect_bro"
      ...
      it "renders validation errors if it is not unconditionally valid" do
        flatpage = create :flatpage
        put :preview,
          :id         => flatpage.id,
          :obj_key    => flatpage.obj_key,
          :flatpage   => flatpage.attributes.merge(path: "")
