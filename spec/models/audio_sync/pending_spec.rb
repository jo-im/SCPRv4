...
describe Audio::EncoAudio do
  ...
  describe "::bulk_sync" do
    it "only syncs audio from the past 2 weeks by default" do
      ...
      old_enco   = create :audio, :enco, :live_enco, :awaiting
      new_enco   = create :audio, :enco, :live_enco, :awaiting
  ...
  describe "#sync" do
    it "sets status if the file exists" do
      ...
      enco = create :audio, :enco, :live_enco, :awaiting
    ...
    it "doesn't do anything if the file doesn't exist" do
      ...
      enco = create :audio, :enco, :awaiting,
  ...
  describe '#filename' do
    it "makes the filename based on enco number and date" do
      audio = build :audio, :enco, enco_number: "1234", enco_date: Date.new(1988, 10, 21)
