...
describe Concern::Callbacks::PublishNotificationCallback do
  it "fires when publishing" do
    ...
    Job::PublishNotification.should_receive(:enqueue).with(/\APublished!/, "daily_web")
    story.save!
  end
  ...
  it "fires when unpublishing" do
    ...
    Job::PublishNotification.should_receive(:enqueue).with(/\AUnpublished/, "daily_web")
  ...
  it "fires when status was changed" do
    ...
    Job::PublishNotification.should_receive(:enqueue).with(/\AStatus Changed/, "daily_web")
