...
module Scprv4
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( shared.js outpost/application.css outpost/application.js new.js base/print.css vertical/landing.css vertical/partner-mercedes.css fonts.css )
