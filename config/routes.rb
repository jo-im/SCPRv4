...
Scprv4::Application.routes.draw do
  ...
  # Programs / Segments
  # This route is hard-coded to constrain only The Frame, Take Two and Off-Ramp to render with our new featured program design. 
  # We can remove this as soon as all featured programs get the same red-carpet treatment.
  get '/programs/:show' => "programs#featured_program", constraints: { show: /(the-frame|take-two|offramp)/ }
